...
public class OSP_Model extends ModelBase
{
	//fields
	...
	public OSP_Model()
	{
		...
		AmmoStock = new ModelRenderer(this, 0, 17);
		AmmoStock.addBox(0F, 0F, 0F, 4, 6, 2);
		AmmoStock.setRotationPoint(3F, 4F, -1F);
		AmmoStock.setTextureSize(32, 32);
		AmmoStock.mirror = true;
		setRotation(AmmoStock, 0F, 0F, 0F);
	}
